...
func (d Controller) GetListByRegionID(c *web.Context) error {
	id := c.GetParam(reflect.Int, "region-id").(int)
	...
	list, count, err := d.district.GetDistrictsListByRegionID(c.Ctx, id, filter)
	if err != nil {
		return c.RespondError(err)
	}
